...
- [ ] Se connecter au serveur déployé par l'INFRA (ex. `OLLAMA_URL` = tunnel HTTPS ou `http://localhost:11434` — voir `rendu/web/README.md`)
- [ ] Afficher l'historique de la conversation
- [ ] Montrer l'état de connexion au serveur (connecté / déconnecté)
- [ ] La lancer en une commande depuis `rendu/web/`
...
*(Pour ce projet simplifié : l’interface chat est dans **`rendu/web/`**.)*  
